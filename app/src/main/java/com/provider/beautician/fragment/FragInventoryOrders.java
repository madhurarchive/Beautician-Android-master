 ...
 */
public class FragInventoryOrders extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (rootView == null)
        rootView = inflater.inflate(R.layout.frag_inventory_orders, container, false);
        return rootView;
    }
    ...
    private void initView() {
        txtNewProduct       =   rootView.findViewById(R.id.frag_inventory_orders_txtNewProduct);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.frag_inventory_orders_txtNewProduct:
                ((ActHome)mContext).switchContent(new FragInventoryCreateNewOrder(),FragInventoryCreateNewOrder.class.getSimpleName(),true);
                break;
