 ...
 */
public class FragInventoryCreateNewOrder extends Fragment implements View.OnClickListener {
    ...
    public FragInventoryCreateNewOrder() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (rootView==null)
        rootView = inflater.inflate(R.layout.frag_inventory_create_new_order, container, false);
        return rootView;
    }
    ...
    private void initView() {
        ...
        txtHeader.setText(CommonUtils.gettingString(R.string.select_supplier,mContext));
