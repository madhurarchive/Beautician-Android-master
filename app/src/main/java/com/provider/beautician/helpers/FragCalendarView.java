...
public class FragCalendarView extends LinearLayout
{
    // for logging
    ...
    public FragCalendarView(Context context)
    {
        super(context);
    }

    public FragCalendarView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initControl(context, attrs);
    }

    public FragCalendarView(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    private void initControl(Context context, AttributeSet attrs)
    {
        ...
        inflater.inflate(R.layout.control_frag_calendar, this);
    ...
    public void setUpdateCalendar(int position,Date date)
    {
        selectDate = date;
    ...
    private class CalendarAdapter extends ArrayAdapter<Date>
    {
        ...
        public View getView(final int position, View view, ViewGroup parent)
        {
            ...
            if (view == null)
                view = inflater.inflate(R.layout.control_calendar_frag_day, parent, false);
            ...
            if ((month == today.getMonth()) && (day == today.getDate())) {
                view.setBackground(getResources().getDrawable(R.drawable.ic_current_date_bg));
                ((TextView)view).setTextColor(getResources().getColor(R.color.colorBlack));
            }
            ...
            if (selectDate!=null && selectDate.getDate() != 0 && selectDate.getDate() == day && selectDate.getMonth() == month){
                ...
                view.setBackground(getResources().getDrawable(R.drawable.ic_selected_date_bg));
            }
