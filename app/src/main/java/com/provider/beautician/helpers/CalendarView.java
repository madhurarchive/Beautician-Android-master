...
public class CalendarView extends LinearLayout
{
	...
	public int selectMonth,selectedPosition;
	...
	public void setUpdateCalendar(int position)
	{
	...
	private class CalendarAdapter extends ArrayAdapter<Date>
	{
		...
		public View getView(final int position, View view, ViewGroup parent)
		{
			...
			if ((month == today.getMonth()) && (day == today.getDate())) {
				((TextView)view).setBackground(getResources().getDrawable(R.drawable.ic_inventory_product_edit_bg));
				((TextView)view).setTextColor(getResources().getColor(R.color.colorBlack));
			}

			if (selectDay != 0 && selectDay == day && selectMonth == month){
				((TextView)view).setTextColor(getResources().getColor(R.color.colorWhite));
				((TextView)view).setBackgroundColor(getResources().getColor(R.color.colorBlack));
			}
            ...
            ((TextView)view).setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
					if (((TextView)view).getCurrentTextColor()!=getResources().getColor(R.color.colorDivider)) {
						getFirstDayOfWeek(position);
						eventHandler.onDayLongPress(date, selectedPosition, dates, startDay);
					}
                }
            });
	...
	{
		void onDayLongPress(Date date,int selectedPosition,ArrayList<Date> dates,int startDay);
	}
}
